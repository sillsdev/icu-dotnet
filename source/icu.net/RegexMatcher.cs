...
namespace Icu
{
    ...
    public class RegexMatcher
    {
        ...
        public RegexMatcher(string regexp, Flag[] flags)
		{
            _regexp = regexp;
            ErrorCode e;
            ParseError parseError;

            uint bitOredFlag = flags.Aggregate(0u, (acc, succ) => acc | (uint)succ);
            _regexMatcher = NativeMethods.uregex_open(_regexp, _regexp.Length, bitOredFlag, out parseError, out e);
